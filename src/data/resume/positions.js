const positions = [
  {
    ...
    points: [
      'Enrolled in web development course and completed challenges with little to no help.',
      'Developed various sites using HTML/CSS/Javascript/React/Node Js/ Express/ RESTful APIs/ MongoDB according to the requirements.',
      'Published all the sites on to Git Hub using Git bash commands on hyper terminal.',
      'Attended foundation course from AWS',
      'Enrolled in python introduction program course and completed all challenges',
      'My personal site - https://sandhyadeepch.github.io/personal-site/',
      'Git site - https://github.com/sandhyadeepch',
    ],
  },
  {
    id: '2',
